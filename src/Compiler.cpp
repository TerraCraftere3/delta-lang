...
namespace Delta
{
    ...
    int Compiler::compile(const CompilerProperties &props)
    {
...
#ifdef _WIN32
        std::string linkCommandPostfix = " -luser32 -lgdi32 -lkernel32";
#else
        std::string linkCommandPostfix = " -lX11";
#endif
        ...
        case COMPILE_AND_LINK:
        {
            ...
            std::string linkCommand = "\"" + linkPath + "\" " + objFile + " " + stdlibPath + linkOutputFlag + linkCommandPostfix;
